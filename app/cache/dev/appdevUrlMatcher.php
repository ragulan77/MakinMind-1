...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // resource_homepage
        if (rtrim($pathinfo, '/') === '/uploads') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'resource_homepage');
            }
            return array (  '_controller' => 'MakinMind\\ResourceBundle\\Controller\\uploadController::uploadAction',  '_route' => 'resource_homepage',);
        }

        // resource_personal_uploads
        if ($pathinfo === '/uploads/my-uploads') {
            return array (  '_controller' => 'MakinMind\\ResourceBundle\\Controller\\uploadController::displayUploadsAction',  '_route' => 'resource_personal_uploads',);
        }
        ...
        if (0 === strpos($pathinfo, '/project') && preg_match('#^/project/(?P<id>\\d+)\\-(?P<url>[a-zA-Z0-9-]+)/collaborators$#s', $pathinfo, $matches)) {
