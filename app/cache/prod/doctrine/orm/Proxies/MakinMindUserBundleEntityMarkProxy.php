 ...
 */
class MakinMindUserBundleEntityMarkProxy extends \MakinMind\UserBundle\Entity\Mark implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'mark', 'date', 'comment', 'owner', 'worker', 'project');
    }
