...
class Contract
{
    ...
    /**
     * @var datetime $workerMission
     *
     * @ORM\Column(name="workerMission", type="smallint", nullable=false)
     */
    private $workerMission = 0;
     ...
     * Set workerMission
     *
     * @param smallint $workerMission
     */
    public function setWorkerMission($workerMission)
    {
        $this->workerMission = $workerMission;
    }
     ...
     * @return smallint 
     */
    public function getWorkerMission()
    {
        return $this->workerMission;
    }
}